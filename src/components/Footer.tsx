...
const LinkedInIcon = () => <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
  </svg>;
const YouTubeIcon = () => <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <a href="https://x.com/Sharabumanoj?t=zWNXk-B0Q13uf8PvWeAC-w&s=08" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Twitter/X">
                <TwitterIcon />
              </a>
              <a href="https://www.linkedin.com/in/sharabu-manoj-kumar/?originalSubdomain=in" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="LinkedIn">
                <LinkedInIcon />
              </a>
              <a href="https://www.youtube.com/@sharabumanojkumar" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="YouTube">
                <YouTubeIcon />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              url: "https://indiankanoon.org/search/?formInput=indian+penal+code"
            }, {
              label: "Bharatiya Nyaya Sanhita (BNS)",
              url: "https://www.mha.gov.in/en/bharatiya-nyaya-sanhita"
            }, {
              label: "Code of Criminal Procedure",
              url: "https://indiankanoon.org/search/?formInput=crpc"
            }, {
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <a href="mailto:sharabumanojachari@gmail.com" className="hover:text-primary transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-primary/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-2">
              ...
              <span>© 2024  LeXa AI Lawyer – Smart Judiciary of India. All rights reserved.</span>
            </div>
