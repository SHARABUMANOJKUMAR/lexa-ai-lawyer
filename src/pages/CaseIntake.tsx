...
Generated by AI LeXa Lawyer - Smart Judiciary of India
  ...
  const printFIR = () => {
    ...
    if (printWindow) {
      ...
      // Use textContent to safely insert FIR text without HTML interpretation
      const preEl = printWindow.document.getElementById('fir-content');
      if (preEl) preEl.textContent = generatedFIR;
      printWindow.print();
    }
  };
